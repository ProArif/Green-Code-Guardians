...
class RunnerConfig:
    ...
    name:                       str             = "llama2_generation_experiment"
    ...
    def create_run_table_model(self) -> RunTableModel:
        ...
        factor1 = FactorModel("factor-chatbot", ['chatgpt', 'llama2', 'bard'])
        factor2 = FactorModel("factor-interaction", ['generation', 'knowledge', 'real'])
        self.run_table_model = RunTableModel(
            ...
            data_columns=['avg_cpu', 'total_energy'] # summary statistics
        )
    ...
    def start_run(self, context: RunnerContext) -> None:
        ...
        # start the target
        self.target = subprocess.Popen(['python', './llama2.py'],
